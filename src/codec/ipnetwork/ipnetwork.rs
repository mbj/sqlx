...
impl Type for IpNetwork {
    fn type_info() -> TypeInfo {
        TypeInfo::INET
    }

    fn compatible(ty: &TypeInfo) -> bool {
        *ty == TypeInfo::CIDR || *ty == TypeInfo::INET
    }
}

impl HasArrayType for IpNetwork {
    fn array_type_info() -> TypeInfo {
        TypeInfo::INET_ARRAY
    }

    fn array_compatible(ty: &TypeInfo) -> bool {
        *ty == TypeInfo::CIDR_ARRAY || *ty == TypeInfo::INET_ARRAY
    }
}

impl Encode<'_> for IpNetwork {
