...
```rust,no_run
use sqlx::{Connection, ConnectOptions, SslMode};

# async fn example() -> sqlx::Result<()> {
// URL connection string
let conn = Connection::connect("postgres://localhost/mydb").await?;

// Manually-constructed options starting from hardcoded defaults
...
let opts: ConnectOptions = "postgres://localhost/mydb".parse()?;
let conn = opts
